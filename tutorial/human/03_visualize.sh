...
$sing churros_visualize -b 5000 -l 8000 -P "--scale_tag 100" samplepairlist.txt drompa+.bin5k $build $Ddir

# visualize -log10(p) distribution
$sing churros_visualize --pvalue -b 5000 -l 8000 samplepairlist.txt drompa+.pval.bin5k $build $Ddir
