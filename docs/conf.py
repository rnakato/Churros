...
latex_documents = [
    (master_doc, 'Churros.tex', 'Churros Documentation',
...
man_pages = [
    (master_doc, 'Churros', 'Churros Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Churros', 'Churros Documentation',
     author, 'Churros', 'One line description of project.',
     'Miscellaneous'),
]
